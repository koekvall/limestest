...
// loglik_psiRcpp
Rcpp::List loglik_psiRcpp(Eigen::MappedSparseMatrix<double> Z, Eigen::Map<Eigen::VectorXd> e, Eigen::MappedSparseMatrix<double> H, Eigen::MappedSparseMatrix<double> Psi0, double psi0, bool loglik, bool score, bool finf, bool expected);
