...
precomp <- reconf:::get_precomp_lmer(fit)
...
# Test likelihoods
# Regular likelihood
loglik_R <- reconf:::loglik_psi(Z = Z,
...
loglik_cpp <- reconf:::loglik(Psi_r = Psi_cpp / psi_hat[r],
                                 psi_r = psi_hat[r],
                                 H = H,
                                 e = Y,
                                 X = X,
...
loglik_cpp <- loglik_cpp <- reconf:::loglik(Psi_r = Psi_cpp / psi_hat[r],
                                               psi_r = psi_hat[r],
                                               H = H,
                                               e = Y,
                                               X = X,
...
resloglik_R <- reconf:::res_ll(XtX = crossprod(X),
                               XtY = crossprod(X, Y),
                               XtZ = crossprod(X, Z),
                               ZtZ = crossprod(Z),
                               crossprod(Y, Z),
...
resloglik_cpp <- reconf:::loglik_res(Y = Y,
                                     X = X,
                                     Z = Z,
